...
export default function SupplierEditForm({ params }) {
  const { id } = use(params);
  ...
  if (loadingData) {
    return <article className="gestomag__page"><p>Chargement...</p></article>;
  }
    ...
    <article className="gestomag__page">
      <header className="gestomag__header">
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <h1 className="gestomag__title">Modifier le Fournisseur</h1>
        </div>
      </header>
